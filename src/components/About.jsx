    ...
    <section id="about" className="py-28 md:py-36 px-6 max-w-6xl mx-auto">
      ...
      >
        <div className="md:sticky md:top-32">
          <p className="text-text-muted text-sm uppercase tracking-widest mb-4">About</p>
          <h2 className="text-4xl md:text-5xl font-semibold tracking-tight text-text-primary">
            Mohanth
          </h2>
        </div>
        <div className="space-y-10">
          <div className="w-40 h-40 rounded-2xl bg-background-secondary border border-[rgba(255,255,255,0.08)] flex items-center justify-center text-4xl text-text-muted font-light">
            M
          </div>
